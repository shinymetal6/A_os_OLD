/* Generated by NFCC Configuration Software 0.1.24.0 */
/******************************************************************************
  * @attention
  *
 ...
 ******************************************************************************
 */
#include "../RFAL/rfal_analogConfig.h"
...
/*! Macro for Configuration Setting with only 18 register-mask-value set:
*  - Configuration ID[2], Number of Register sets to follow[1], Register[2], Mask[1], Value[1], Register[2], Mask[1], Value[1], Register[2]... */
...
const uint8_t rfalAnalogConfigCustomSettings[] = {
    ...
    /* Mode Name: POLL_A_COMMON_TX, Mode ID: 0x0101 */
    ...
    MODE_ENTRY_6_REG(0x0112,
        0x000b,0xff,0x08, /* Receiver Conf 1 */
        0x000c,0xff,0xed, /* Receiver Conf 2 */
        0x000d,0xff,0x00, /* Receiver Conf 3 */
        0x000e,0xff,0x00, /* Receiver Conf 4 */
        0x004c,0xff,0x51, /* Correlator Conf 1 */
        0x004d,0xff,0x00  /* Correlator Conf 2 */
    ),

    /* Mode Name: POLL_A_212_RX, Mode ID: 0x0122 */
    MODE_ENTRY_6_REG(0x0122,
        0x000b,0xff,0x02, /* Receiver Conf 1 */
    ...
    MODE_ENTRY_6_REG(0x0132,
        0x000b,0xff,0x42, /* Receiver Conf 1 */
        0x000c,0xff,0xfd, /* Receiver Conf 2 */
        0x000d,0xff,0x00, /* Receiver Conf 3 */
        0x000e,0xff,0x00, /* Receiver Conf 4 */
    ...
    MODE_ENTRY_1_REG(0x0103,
        0x004c,0x40,0x00  /* User Defined ; Different data slicer to improve collision detection */
    ),

    /* Mode Name: POLL_B_COMMON_TX, Mode ID: 0x0201 */
    ...
    MODE_ENTRY_6_REG(0x0212,
        0x000b,0xff,0x04, /* Receiver Conf 1 */
        0x000c,0xff,0xfd, /* Receiver Conf 2 */
        0x000d,0xff,0x00, /* Receiver Conf 3 */
        0x000e,0xff,0x00, /* Receiver Conf 4 */
        0x004c,0xff,0x97, /* Correlator Conf 1 */
    ...
    /* Mode Name: POLL_B_848_TX, Mode ID: 0x0241 */
    ...
    /* Mode Name: POLL_F_COMMON_TX, Mode ID: 0x0401 */
    ...
    MODE_ENTRY_6_REG(0x0402,
        0x000b,0xff,0x13, /* Receiver Conf 1 */
        0x000c,0xff,0xfd, /* Receiver Conf 2 */
        0x000d,0xff,0x00, /* Receiver Conf 3 */
        0x000e,0xff,0x00, /* Receiver Conf 4 */
        0x004c,0xff,0x54, /* Correlator Conf 1 */
        0x004d,0xff,0x00  /* Correlator Conf 2 */
    ),
    ...
    MODE_ENTRY_6_REG(0x1002,
        ...
        0x000d,0xff,0x00, /* Receiver Conf 3 */
        0x000e,0xff,0x00, /* Receiver Conf 4 */
        0x004c,0xff,0x13, /* Correlator Conf 1 */
        0x004d,0xff,0x01  /* Correlator Conf 2 */
    ),
