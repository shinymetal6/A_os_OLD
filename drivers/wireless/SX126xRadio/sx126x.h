...
#endif
extern	void SX126xWriteBuffer( uint8_t offset, uint8_t *buffer, uint8_t size );
extern	void SX126xCheckDeviceReady( void );
extern	void SX126xInit( void );
extern	void SX126xSetStandby( RadioStandbyModes_t standbyConfig );
extern	void SX126xGetRxBufferStatus( uint8_t *payloadLength, uint8_t *rxStartBufferPointer );
extern	void SX126xReadBuffer( uint8_t offset, uint8_t *buffer, uint8_t size );
extern	void SX126xSetTx( uint32_t timeout );
extern	void SX126xSetTxContinuousWave( void );
extern	void SX126xSetTxParams( int8_t power, RadioRampTimes_t rampTime );
extern	void SX126xWriteRegisters( uint16_t address, uint8_t *buffer, uint16_t size );
extern	void SX126xSetRx( uint32_t timeout );
extern	void SX126xReadRegisters( uint16_t address, uint8_t *buffer, uint16_t size );
extern	void SX126xSetTxParams( int8_t power, RadioRampTimes_t rampTime );
extern	void SX126xSetRegulatorMode( RadioRegulatorMode_t mode );
extern	void SX126xSetBufferBaseAddress( uint8_t txBaseAddress, uint8_t rxBaseAddress );
extern	void SX126xSetDioIrqParams( uint16_t irqMask, uint16_t dio1Mask, uint16_t dio2Mask, uint16_t dio3Mask );
extern	RadioOperatingModes_t SX126xGetOperatingMode( void );
extern	void SX126xSetPacketType( RadioPacketTypes_t packetType );
extern	void RadioSetPublicNetwork( bool enable );
extern	uint8_t SX126xGetPayload( uint8_t *buffer, uint8_t *size,  uint8_t maxSize );
extern	uint16_t SX126xGetIrqStatus( void );
extern	void SX126xClearIrqStatus( uint16_t irq );
extern	void SX126xSetCad( void );
extern	void SX126xSetRxDutyCycle( uint32_t rxTime, uint32_t sleepTime );
extern	void SX126xGetPacketStatus( PacketStatus_t *pktStatus );
extern	void SX126xSetRxBoosted( uint32_t timeout );
extern	void SX126xSetSleep( SleepParams_t sleepConfig );
extern	void SX126xSendPayload( uint8_t *payload, uint8_t size, uint32_t timeout );
extern	RadioPacketTypes_t SX126xGetPacketType( void );
extern	void SX126xSetModulationParams( ModulationParams_t *modulationParams );
extern	void SX126xSetWhiteningSeed( uint16_t seed );
extern	void SX126xSetRfFrequency( uint32_t frequency );
extern	void SX126xSetStopRxTimerOnPreambleDetect( bool enable );
extern	void SX126xSetPacketParams( PacketParams_t *packetParams );
extern	uint8_t SX126xSetSyncWord( uint8_t *syncWord );
extern	int8_t SX126xGetRssiInst( void );
extern	void SX126xSetLoRaSymbNumTimeout( uint8_t SymbNum );
